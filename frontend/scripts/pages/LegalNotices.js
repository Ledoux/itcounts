...
const content = {
  introduction: `Conformément aux dispositions de l’article 6 III 1 de la loi n°2004-575 du 21 juin 2004 pour la confiance dans l’économie numérique, l’utilisateur du site internet pariteaupouvoir.com (ci-après, « le Site ») est informé des mentions légales suivantes :
    Site accessible à partir de l’URL : http://pariteaupouvoir.com/
    Editeur du site
    L’éditeur du site est Wax Science, association loi 1901 dont le siège social est situé au 33 Avenue du Maine, 75015 Paris.
    Adresse email : agathe-brusset@wax-science.fr
    Directrice de la Publication : Agathe Brusset
    Hébergeur :
    Le site est hébergé en France sur les serveurs de la société 1and1, dont le siège social est situé au Internet SARL 7, place de la Gare BP 70109 57201 Sarreguemines Cedex.
    Conception et réalisation du Site :
    Ce site internet a été réalisé avec le travail bénévole de DATA FOR GOOD, SNIPS et Wax Science.
  `,
  sections: [
    {
      ...
      text: `En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour
        ...
        Propriétaire : WAX Science  – Centre de Recherches Interdisciplinaires 8 rue Charles V 75004 Paris
        Créateur : Agathe Brusset
        Responsable publication : Agathe Brusset – agathe.brusset@wax-science.fr
        Le responsable publication est une personne physique ou une personne morale.
        Webmaster : Agathe Brusset – agathe.brusset@wax-science.fr
    ...
    },
    {
      ...
      les utilisateurs du site www.pariteaupouvoir.com sont donc invités
      ...
      décidée par WAX Science, qui s’efforcera alors de communiquer préalablement
      aux utilisateurs les dates et heures de l’intervention.

      Le site www.pariteaupouvoir.com est mis à jour régulièrement par Agathe
      Brusset. De la même façon, les mentions légales peuvent être modifiées
    ...
    },
    {
      ...
      WAX Science s’efforce de fournir sur le site www.pariteaupouvoir.com des
      ...
      Tous les informations indiquées sur le site www.pariteaupouvoir.com
      sont données à titre indicatif, et sont susceptibles d’évoluer.
      Par ailleurs, les renseignements figurant sur le site
      www.pariteaupouvoir.com ne sont pas exhaustifs. Ils sont donnés sous
    ...
    },
    {
      ...
      text: `WAX Science est propriétaire des droits de propriété intellectuelle
    ...
    },
    {
      ...
      contact) sont à la disposition des utilisateurs. WAX Science se réserve
      ...
      Le cas échéant, WAX Science se réserve également la possibilité de
    ...
    },
    {
      ...
      text: `En France, les données personnelles sont notamment protégées par
      la loi n° 78-87 du 6 janvier 1978, la loi n° 2004-801 du 6 août 2004,
      l'article L. 226-13 du Code pénal et la Directive Européenne
      du 24 octobre 1995.

      A l'occasion de l'utilisation du site www.pariteaupouvoir.com,
      peuvent êtres recueillies : l'URL des liens par l'intermédiaire desquels
      l'utilisateur a accédé au site www.pariteaupouvoir.com,
      le fournisseur d'accès de l'utilisateur,
      l'adresse de protocole Internet (IP) de l'utilisateur.

      En tout état de cause WAX Science ne collecte des informations
      personnelles relatives à l'utilisateur que pour le besoin de
      certains services proposés par le site www.pariteaupouvoir.com.
      ...
      Il est alors précisé à l'utilisateur du site www.pariteaupouvoir.com
      ...
      sa demande écrite et signée, accompagnée d’une copie du titre d’identité
      avec signature du titulaire de la pièce, en précisant l’adresse à laquelle
      la réponse doit être envoyée.

      Aucune information personnelle de l'utilisateur du site
      www.pariteaupouvoir.com n'est publiée à l'insu de l'utilisateur,
      échangée, transférée, cédée ou vendue sur un support quelconque à des
      tiers. Seule l'hypothèse du rachat de WAX Science et de ses droits
    ...
    },
    {
      ...
      text: `Le site www.pariteaupouvoir.com contient un certain nombre de
      liens hypertextes vers d’autres sites, mis en place avec l’autorisation
      de WAX Science. Cependant, WAX Science n’a pas la possibilité de
      vérifier le contenu des sites ainsi visités,
      et n’assumera en conséquence aucune responsabilité de ce fait.

      La navigation sur le site www.pariteaupouvoir.com est susceptible
      ...
      Vie privée. Paramétrez les Règles de conservation sur : utiliser
      les paramètres personnalisés pour l'historique. Enfin décochez-la
      ...
      Dans la section "Confidentialité", cliquez sur préférences.
      Dans l'onglet "Confidentialité", vous pouvez bloquer les cookies.`
    },
    {
      title: 'Droit applicable et attribution de juridiction',
      text: `Tout litige en relation avec l’utilisation du site
      www.pariteaupouvoir.com est soumis au droit français.
      Il est fait attribution exclusive de juridiction aux
      tribunaux compétents de Paris.`
    },
    {
      title: 'Les principales lois concernées',
      text: `Loi n° 78-17 du 6 janvier 1978, notamment modifiée par la loi
      n° 2004-801 du 6 août 2004 relative à l'informatique, aux fichiers
      et aux libertés. Loi n° 2004-575 du 21 juin 2004 pour
